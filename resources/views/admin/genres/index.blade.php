...
@section('content')
    ...
    <div class="d-flex justify-content-end mt-3 mb-3">
        <a href="{{ route('add.genre') }}" class="btn btn-success">Create</a>
    </div>
    ...
    <table class="table table-striped table-hover text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="/admin/genre/destroy/{{ $item->id }}" method="post">
                        @csrf
                        @method('DELETE')
                        ...
                        <a href="/admin/genre/edit/{{ $item->id }}" class="btn btn-primary"><i class='bx bx-edit'></i></a>
                    </form>
